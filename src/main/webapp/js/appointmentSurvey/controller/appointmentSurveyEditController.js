 ...
 */
'use strict';
application.controller('appointmentSurveyEditController', [
    '$scope',
    'appointmentSurveyService',
    '$location',
    function ($scope, appointmentSurveyService, $location) {
        // function to save a new survey
        $scope.saveSurvey = function () {
            appointmentSurveyService.saveSurvey($scope.survey)
